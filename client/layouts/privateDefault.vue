...
.page {
  ...
  > .footer {
    ...
    .summary {
      @apply tw-justify-self-center tw-flex tw-items-center tw-justify-center tw-w-10/12 tw-pr-80;
    ...
    .cw {
      @apply tw-justify-self-end tw-flex tw-text-gray3 tw-px-3 tw-w-1/6  tw-justify-end;
    }
  }
