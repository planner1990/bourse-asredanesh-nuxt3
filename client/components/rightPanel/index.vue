                    ...
                    <v-list-item v-on="on" v-bind="attrs" class="item mx-1" :to="child.to ? child.to : '#'">
                      ...
                      <div v-if="child.to && child.to != ''" class="d-flex flex-row my-0">
                        ...
                        " v-if="child.bookmarkPosition" icon x-small>
                          ...
                          <path d="M7.41016 0H2.59016C1.52516 0 0.660156 0.87 0.660156 1.93V8.975C0.660156 9.875 1.30516 10.255 2.09516 9.82L4.53516 8.465C4.79516 8.32 5.21516 8.32 5.47016 8.465L7.91016 9.82C8.70016 10.26 9.34516 9.88 9.34516 8.975V1.93C9.34016 0.87 8.47516 0 7.41016 0Z" :fill="isMarked(child) ? '#E5E9FA' : '#3554D1'"/>
                          </svg>
