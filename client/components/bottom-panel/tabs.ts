  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        deletable: false,
        match:
          /^\/watchlist\/.+\/furtherInformation\/myGroups([?](.+[=].+[&]?)+)?([\/]{1})?$/g,
      },
      {
        ...
        deletable: false,
        match:
          /^\/watchlist\/.+\/furtherInformation\/holdersGroups([?](.+[=].+[&]?)+)?([\/]{1})?$/g,
      },
      {
        ...
        deletable: false,
        match:
          /^\/watchlist\/.+\/furtherInformation\/holdersCombination([?](.+[=].+[&]?)+)?([\/]{1})?$/g,
      },
      {
        ...
        deletable: false,
        match:
          /^\/watchlist\/.+\/furtherInformation\/type([?](.+[=].+[&]?)+)?([\/]{1})?$/g,
      },
      {
        ...
        deletable: false,
        match:
          /^\/watchlist\/.+\/furtherInformation\/trades([?](.+[=].+[&]?)+)?([\/]{1})?$/g,
      },
      {
        ...
        deletable: false,
        match:
          /^\/watchlist\/.+\/furtherInformation\/papers([?](.+[=].+[&]?)+)?([\/]{1})?$/g,
      },
    ],
    match: /^\/watchlist\/.+\/furtherInformation$/g,
    path: "furtherInformation",
