    ...
    <div class="detail" v-if="bottomPanel.activeTab">
      ...
      <header class="header">
        ...
        <ada-btn class="tw-mx-[5px] tw-h-[24px] tw-w-[24px]"
                 :class="[expanded && bottomPanel.activeTab != null ? 'tw-bg-primary' : 'tw-bg-transparent']"
                 @click="expand">
          <ada-icon :class="[expanded && bottomPanel.activeTab != null ? 'tw-text-white' : 'tw-text-primary']"
                    :size="16"> isax-maximize-3
          </ada-icon>
        </ada-btn>
