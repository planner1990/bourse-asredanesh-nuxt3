...
const ripples = {
  ...
  show(e: VuetifyRippleEvent, el: rippleElement, value: RippleOptions = {}) {
...
function rippleShow(e: VuetifyRippleEvent) {
  ...
  const element = e.currentTarget as rippleElement;
    ...
    node.context &&
      node.context.$nextTick(() => {
        ...
        if (computed && computed.display === "inline") {
          const context = (node as any).fnOptions
            ? [(node as any).fnOptions, node.context]
